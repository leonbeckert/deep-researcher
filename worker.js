...
<body class="min-h-full bg-zinc-950 text-zinc-100 antialiased [font-family:-apple-system,BlinkMacSystemFont,'Segoe_UI',system-ui,sans-serif]">
  ...
  <div class="showcase">
    <div class="showcase-card">
      <img src="https://raw.githubusercontent.com/leonbeckert/deep-researcher/main/screenshots/hero-airesearch-title.png" alt="AI-Based Research Tools Report \u2014 Titelseite" loading="lazy">
    </div>
    <div class="showcase-card">
  ...
  <section class="mx-auto max-w-4xl px-6 py-16 sm:py-20">
    ...
    <div class="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
      <article class="group overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900">
        <div class="relative max-h-48 overflow-hidden transition-[max-height] duration-500 ease-out group-hover:max-h-[2400px]">
          <img src="https://raw.githubusercontent.com/leonbeckert/deep-researcher/main/screenshots/preview-dateiorganisation.png" alt="Dateiorganisation Report \u2014 Seite 1" class="block w-full" loading="lazy">
          <div class="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-zinc-900 transition-opacity duration-300 group-hover:opacity-0"></div>
        </div>
        <div class="p-6">
          ...
          <div class="mt-5 flex flex-wrap gap-2">
            ...
            <a href="https://raw.githubusercontent.com/leonbeckert/deep-researcher/main/examples/dateiorganisation-kleinunternehmen/Dateiorganisation%20f%C3%BCr%20Kleinunternehmen%20Mensch-%20und%20KI-freundliche%20Strategien%20%E2%80%94%202026-04-01%20(Dark).pdf" class="inline-flex items-center gap-1.5 rounded-md bg-zinc-950 px-3 py-1.5 text-xs font-semibold text-zinc-400 ring-1 ring-inset ring-zinc-800 transition hover:text-zinc-100 hover:ring-zinc-700"><span class="font-mono uppercase tracking-wide">PDF</span><span>Dark</span></a>
      ...
      <article class="group overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900">
        <div class="relative max-h-48 overflow-hidden transition-[max-height] duration-500 ease-out group-hover:max-h-[2400px]">
          <img src="https://raw.githubusercontent.com/leonbeckert/deep-researcher/main/screenshots/preview-peak-performance.png" alt="Peak Performance Report \u2014 Seite 1" class="block w-full" loading="lazy">
          <div class="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-zinc-900 transition-opacity duration-300 group-hover:opacity-0"></div>
        </div>
        <div class="p-6">
          <div class="flex flex-wrap items-center gap-2">
          ...
          <div class="mt-5 flex flex-wrap gap-2">
            ...
            <a href="https://raw.githubusercontent.com/leonbeckert/deep-researcher/main/examples/peak-performance-wissenschaft/Die%20Wissenschaft%20hinter%20kognitiver%20H%C3%B6chstleistung%20%E2%80%94%202026-04-01%20(Dark).pdf" class="inline-flex items-center gap-1.5 rounded-md bg-zinc-950 px-3 py-1.5 text-xs font-semibold text-zinc-400 ring-1 ring-inset ring-zinc-800 transition hover:text-zinc-100 hover:ring-zinc-700"><span class="font-mono uppercase tracking-wide">PDF</span><span>Dark</span></a>
      ...
      <article class="group overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900">
        <div class="relative max-h-48 overflow-hidden transition-[max-height] duration-500 ease-out group-hover:max-h-[2400px]">
          <img src="https://raw.githubusercontent.com/leonbeckert/deep-researcher/main/screenshots/preview-programmiersprachen.png" alt="Programmiersprachen Report \u2014 Seite 1" class="block w-full" loading="lazy">
          <div class="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-zinc-900 transition-opacity duration-300 group-hover:opacity-0"></div>
        </div>
        <div class="p-6">
          <div class="flex flex-wrap items-center gap-2">
      ...
      <article class="group overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900">
        <div class="relative max-h-48 overflow-hidden transition-[max-height] duration-500 ease-out group-hover:max-h-[2400px]">
          <img src="https://raw.githubusercontent.com/leonbeckert/deep-researcher/main/screenshots/preview-ai-research-tools.png" alt="AI-Based Research Tools Report \u2014 Seite 1" class="block w-full" loading="lazy">
          <div class="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-zinc-900 transition-opacity duration-300 group-hover:opacity-0"></div>
        </div>
        <div class="p-6">
          <div class="flex flex-wrap items-center gap-2">
  ...
  <section class="mx-auto max-w-4xl px-6 py-16 sm:py-20">
    ...
    <div class="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      <div class="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
        <h3 class="text-base font-semibold text-zinc-100">Light &amp; Dark PDF</h3>
        <p class="mt-1.5 text-sm text-zinc-400">Jede Recherche wird automatisch als Markdown, DOCX und PDF exportiert \u2014 PDF in hellem und dunklem Design.</p>
      </div>
      <div class="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
